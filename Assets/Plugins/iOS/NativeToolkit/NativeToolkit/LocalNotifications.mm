...
//		}
		...
		if (isRegisteredForNotifications) return;
    ...
    void scheduleLocalNotification(char* idx, char* title, char* message, float delayInMinutes, char* sound)
    {
		registerForNotifications();
        
        NSDate* currentDate = [NSDate date];
        NSDate* notifyDate = [currentDate dateByAddingTimeInterval:delayInMinutes*60.0];
