...
public class PostProcessor 
{
    ...
    public static void OnPostProcessBuild(BuildTarget target, string path)
    {
        ...
        rootDict.SetString("NSBluetoothAlwaysUsageDescription", "Requires access to Bluetooth");
        rootDict.SetString("NSBluetoothPeripheralUsageDescription", "Using Bluetooth to find nearby Bacons");
